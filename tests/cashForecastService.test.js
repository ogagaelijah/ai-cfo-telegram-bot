...
// ======================================================
// IMPORT FORECAST SERVICE AFTER MOCKS
// ======================================================
...
beforeEach(() => {
    ...
    getAverageDailySalesMock.mockReturnValue(
        100000
    );


    getAverageDailyPurchasesMock.mockReturnValue(
        20000
    );


    getAverageDailyExpensesMock.mockReturnValue(
        10000
    );
