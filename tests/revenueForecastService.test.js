...
describe(
    ...
    () => {
        ...
        // ======================================================
        // ADDITIONAL REVENUE FORECAST BOUNDARY TESTS
        // ======================================================

        describe(
            "Revenue Forecast Boundary Rules",
            () => {

                // ==================================================
                // EXACT 6-DAY BOUNDARY
                // ==================================================

                it(
                    "should not apply trend adjustment at exactly 6 active sales days",
                    () => {
                ...
                it(
                    "should apply trend adjustment at exactly 7 active sales days",
                    () => {
                ...
                // ==================================================
                // 13-DAY CONFIDENCE BOUNDARY
                // ==================================================

                it(
                    "should return 80 confidence at exactly 13 active sales days",
                    () => {
                ...
                // ==================================================
                // 14-DAY CONFIDENCE BOUNDARY
                // ==================================================

                it(
                    "should return 90 confidence at exactly 14 active sales days",
                    () => {
                ...
                // ==================================================
                // 29-DAY CONFIDENCE BOUNDARY
                // ==================================================

                it(
                    "should return 90 confidence at exactly 29 active sales days",
                    () => {
                ...
                // ==================================================
                // 30-DAY CONFIDENCE BOUNDARY
                // ==================================================

                it(
                    "should return 95 confidence at exactly 30 active sales days",
                    () => {
                ...
                it(
                    "should return 0 for No Data trend",
                    () => {
